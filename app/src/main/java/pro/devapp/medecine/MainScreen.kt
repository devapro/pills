...
enum class MainScreen (@IdRes val menuItemId: Int,
    ...
    MEDICATION(R.id.tab_medication, R.drawable.ic_medication, R.string.bottom_menu_medication, MedecineListFragment()),
    SETTINGS(R.id.tab_settings, R.drawable.ic_settings, R.string.bottom_menu_settings, SettingsFragment()),
    REPORTS(R.id.tab_reports, R.drawable.ic_reports, R.string.bottom_menu_reports, ReportsFragment()),
}
